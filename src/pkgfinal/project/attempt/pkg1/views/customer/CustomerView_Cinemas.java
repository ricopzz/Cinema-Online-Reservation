 ...
 * @author Yosua
 */
public class CustomerView_Cinemas extends javax.swing.JFrame {

    /**
     * Creates new form CustomerView_Interface_V2
     */
    public CustomerView_Cinemas() {
        initComponents();
        String index = null;
    }
    ...
    private void initComponents() {
        ...
        tblCinema.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Address", "Number of Theaters"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerView_Cinemas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerView_Cinemas().setVisible(true);
            }
        });
    }
    ...
    public void setCinemaTableModel(DefaultTableModel a) {
        tblCinema.setModel(a);
    }
}
